...
DoubleSolenoid* RobotMap::pincerPinch = NULL;
DoubleSolenoid* RobotMap::tiltTilt = NULL;
...
void RobotMap::init() {
	...
	driveControl = new RobotDrive(driveLSpeed, driveRSpeed); //KomodoDrive(driveLSpeed, driveRSpeed, .5, 1);
	...
	driveREncoder->SetDistancePerPulse(1.0);
        ...
        pincerPinch = new DoubleSolenoid(1, 1, 2);   
	tiltTilt = new DoubleSolenoid(1, 3, 4);      
